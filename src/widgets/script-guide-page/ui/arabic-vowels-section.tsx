...
import { VOWELS } from "../lib/arabic-data";
...
export const ArabicVowelsSection = () => {
	const { t } = useI18n();

	return (
		<GuideSection
			id="arabic-vowels"
			title={t("scriptGuide.arabic.vowelsTitle")}
			description={t("scriptGuide.arabic.vowelsDesc")}
		>
			<div className="overflow-x-auto rounded-card border border-bd-1 [&::-webkit-scrollbar]:h-0">
				<table
					...
					aria-label={t("scriptGuide.arabic.vowelsTitle")}
				>
					<thead>
						<tr className="border-b border-bd-1 bg-surf-2 text-left">
							...
							<th className="px-3.5 py-2.5 text-right text-[10.5px] font-semibold uppercase tracking-[0.3px] text-t-3">
								{t("scriptGuide.arabic.short")}
							</th>
							<th className="px-3.5 py-2.5 text-right text-[10.5px] font-semibold uppercase tracking-[0.3px] text-t-3">
								{t("scriptGuide.arabic.long")}
							</th>
							<th className="px-3.5 py-2.5 text-right text-[10.5px] font-semibold uppercase tracking-[0.3px] text-t-3">
