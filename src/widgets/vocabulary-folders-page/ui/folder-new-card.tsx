	...
	return (
		<Button
			...
			className={cn(
				...
				"border-[0.5px] border-dashed border-bd-2 bg-transparent px-4 py-7 text-center",
		...
		>
			<Typography
				tag="span"
				className="text-t-4 transition-colors group-hover:text-acc max-md:flex max-md:items-center max-md:justify-center"
			>
			...
			<div className="flex flex-col gap-1 max-md:items-start">
				<Typography
					tag="span"
					className="text-[13px] font-semibold text-t-3 transition-colors group-hover:text-acc-t"
				>
