      ...
      {items.map((rule) => (
        ...
        >
          ...
          <div className="mb-2.5 flex flex-wrap items-center gap-1.5 rounded-lg border border-bd-1 bg-surf-2 px-2.5 py-1.5">
            ...
            <svg className="text-t-3" width="12" height="12" viewBox="0 0 16 16" fill="none">
              <path d="M3 8h10M9 5l4 3-4 3" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          ...
          <div className="mb-2.5 flex flex-wrap items-center gap-2">
            ...
            <span className="text-[11.5px] text-t-3">{rule.type.toLowerCase()}</span>
            <span
              className={cn(
            ...
            <div className="flex shrink-0 gap-1.5">
              {!rule.isActive && (
                <button
                  ...
                  className="flex h-[30px] items-center gap-1.5 rounded-[7px] border border-bd-2 bg-surf-2 px-2.5 text-[11.5px] font-medium text-t-2 transition-colors hover:bg-surf-3"
                >
              ...
              <button
                onClick={() => onEdit(rule)}
                className="flex size-[30px] items-center justify-center rounded-[7px] border border-bd-2 bg-surf-2 text-t-2 transition-colors hover:bg-surf-3"
              >
              ...
              <button
                ...
                className="flex size-[30px] items-center justify-center rounded-[7px] border border-red/20 bg-surf-2 text-t-3 transition-colors hover:bg-red-bg hover:text-red-t"
              >
                <svg width="13" height="13" viewBox="0 0 16 16" fill="none">
                  <path
