		...
		<div className="flex flex-col gap-[3px]">
			<div className="font-mono text-[13.5px] font-semibold text-t-1">
				{isRegex ? (
					...
					<>
						...
						<Typography
							tag="span"
							className="rounded bg-acc-bg px-[3px] font-bold text-acc-t"
						>
							{suffix}
						</Typography>
					</>
			...
			<div className="flex items-center gap-1 text-[11px] text-t-3">
				...
				{isRegex && (
					<Typography
						tag="span"
						className="rounded bg-pur-bg px-1 py-px text-[9.5px] font-bold uppercase tracking-[0.3px] text-pur-t"
					>
						Regex
					</Typography>
				)}
...
const ReplaceCell = ({ rule }: { rule: MorphRule }) => (
	<div className="flex items-center gap-1.5">
		<Typography
			tag="span"
			className="rounded bg-red-bg px-1.5 py-px font-mono text-[12px] font-semibold text-red-t"
		>
			{rule.suffix}
		</Typography>
		...
		<Typography
			tag="span"
			className="rounded bg-grn-bg px-1.5 py-px font-mono text-[12px] font-semibold text-grn-t"
		>
			{rule.add || "∅"}
		</Typography>
	</div>
...
const MatchBar = ({ count, max }: { count: number; max: number }) => {
	...
	return (
		<div className="flex min-w-[90px] items-center gap-1.5">
			...
			<Typography
				tag="span"
				className="min-w-[32px] text-right font-[tabular-nums] text-[11px] text-t-3"
			>
...
const StatusBadge = ({ isActive }: { isActive: boolean }) =>
	isActive ? (
		<Typography
			tag="span"
			className="inline-flex items-center gap-1 rounded-[5px] bg-grn-bg px-1.5 py-0.5 text-[10.5px] font-semibold text-grn-t"
		>
			<Typography
				tag="span"
		...
		<Typography
			tag="span"
			className="inline-flex items-center gap-1 rounded-[5px] bg-surf-3 px-1.5 py-0.5 text-[10.5px] font-semibold text-t-2"
		>
			<Typography
				tag="span"
				className="size-1.5 rounded-full bg-current opacity-70"
