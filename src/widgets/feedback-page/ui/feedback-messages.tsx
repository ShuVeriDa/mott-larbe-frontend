...
export const FeedbackMessages = ({
	...
	return (
		<div className="flex flex-1 flex-col gap-3.5 bg-panel overflow-y-auto px-5 py-[18px] [&::-webkit-scrollbar-thumb]:rounded-sm [&::-webkit-scrollbar-thumb]:bg-bd-2 [&::-webkit-scrollbar]:w-1 max-sm:px-4">
			{groups.map(group => (
