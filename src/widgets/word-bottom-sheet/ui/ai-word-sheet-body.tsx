		...
		<div className="flex min-h-0 flex-1 flex-col">
			<div className="min-h-0 flex-1 overflow-y-auto">
				...
				<div className="border-b border-bd-1 px-4 py-3.5">
					...
					{result.example && (
						<div className="mt-2 text-[12px] text-t-3 italic">
							{result.example}
						</div>
					)}

					{showGloss && (
						<div className="mt-2.5 border-t border-bd-1 pt-2">
							<Button
								size="bare"
								onClick={handleGlossToggle}
								className="flex items-center gap-1.5 text-[11px] text-t-4 hover:text-t-2 transition-colors"
							>
								<ChevronDown
