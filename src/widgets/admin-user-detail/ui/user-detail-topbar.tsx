...
export const UserDetailTopbar = ({ user, mutations }: UserDetailTopbarProps) => {
	const { t } = useI18n();
	...
	return (
		<div className="sticky top-0 z-10 flex items-center gap-2.5 border-b border-bd-1 bg-bg px-[22px] py-3 transition-colors max-sm:px-3.5 max-sm:py-2.5">
