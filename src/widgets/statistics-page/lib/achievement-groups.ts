...
export const GROUPS: AchievementGroup[] = [
	{
...
export const LEFT_GROUPS = GROUPS.filter((_, i) => i % 2 === 0);
export const RIGHT_GROUPS = GROUPS.filter((_, i) => i % 2 === 1);

export const ACHIEVEMENT_LABELS: Record<string, { title: string; desc: string }> = {
