...
const TransactionSection = ({
	...
	return (
		<div className="border-b border-bd-1 px-[15px] py-2.5">
			...
			<OtherPaymentsList payments={otherPayments} t={t} />
		</div>
	);
};
...
export const PaymentDetailPanel = ({
	...
	return (
		<div className="overflow-hidden rounded-card border border-bd-1 bg-surf">
			<UserHeroSection payment={payment} t={t} />
			<AccountSection payment={payment} t={t} />
			<RolesSection payment={payment} t={t} />
			<TransactionSection payment={payment} otherPayments={otherPayments} t={t} />
