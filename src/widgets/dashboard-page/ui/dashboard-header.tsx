...
export const DashboardHeader = ({
	...
	return (
		<header className="flex justify-between shrink-0 items-center gap-3 border-[0.5px] border-b border-bd-1 bg-surf px-[22px] py-3 transition-colors max-md:px-4 max-sm:px-3.5 max-sm:py-2.5">
