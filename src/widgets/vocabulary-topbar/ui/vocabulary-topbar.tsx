...
export const VocabularyTopbar = ({
	...
	return (
		<header>
			<div className="flex justify-between shrink-0 items-center gap-2.5 border-[0.5px] border-b border-bd-1 bg-surf px-[22px] py-3 transition-colors duration-200 max-md:gap-2 max-md:px-[14px] max-md:py-2.5">
				<Typography
					tag="h1"
				...
				<div className="flex items-center gap-2">
					...
					<Button
						...
						className="hidden size-[30px] items-center justify-center rounded-base border-[0.5px] border-bd-2 bg-surf-2 text-t-2 transition-colors hover:text-t-1 max-md:flex"
					>
