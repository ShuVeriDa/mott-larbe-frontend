			...
			<div className="w-[400px] rounded-[14px] border border-bd-2 bg-surf p-5 shadow-[0_4px_12px_rgba(0,0,0,0.08)]">
				...
				<div className="flex justify-end gap-2">
					...
					<button
						...
						onClick={onConfirm}
						disabled={isDeleting}
						className="h-8 cursor-pointer rounded-[7px] bg-red-500 px-3.5 text-[12.5px] font-semibold text-white transition-opacity hover:opacity-[.88] disabled:opacity-50"
					>
						{isDeleting
