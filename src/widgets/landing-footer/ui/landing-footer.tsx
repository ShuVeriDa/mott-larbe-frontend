			...
			<div className="mx-auto w-full max-w-[1120px]">
				<div className="mb-9 grid grid-cols-[1.5fr_1fr_1fr] gap-10 max-[900px]:grid-cols-3 max-[900px]:gap-8 max-[640px]:gap-7 max-[380px]:grid-cols-2">
					<div className="max-[380px]:col-span-2">
						...
						<Typography className="mt-3.5 max-w-[320px] text-[13px] leading-[1.55] text-t-2">
				...
				<div className="flex flex-wrap items-center justify-between gap-3 border-t-[0.5px] border-bd-1 pt-6 text-[12px] text-t-3 max-[640px]:items-center max-[640px]:gap-3.5">
