...
export const TextEditMetaPanel = ({
	...
	const handleTagInputFocus: NonNullable<ComponentProps<"div">["onClick"]> = () => tagInputRef.current?.focus();
								...
								>
									...
									<div className="min-w-0 flex-1">
										<div className="text-xs font-medium text-t-1">
											{v.isCurrent ? t("admin.texts.editPage.versionCurrent") : (v.label ?? `v${v.version}`)}
										</div>
