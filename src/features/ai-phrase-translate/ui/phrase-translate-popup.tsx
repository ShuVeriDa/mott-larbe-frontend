  ...
  return createPortal(
    ...
    >
      ...
      <div className="border-b border-hairline border-bd-1 px-3.5 py-2.5">
        <div className="text-[13px] font-medium text-t-1 line-clamp-2">{phrase}</div>
      </div>
      ...
      {!hasKey ? (
        ...
        <div className="flex flex-col items-center justify-center gap-2 p-5">
          ...
          <div className="text-[11.5px] text-t-3">{t("aiTranslation.phrase.translating")}</div>
        </div>
      ) : state.phase === "error" ? (
        ...
        <>
          <div className="px-3.5 py-3">
            <div className="flex items-start justify-between gap-2">
              <div className="text-[14px] font-medium text-t-1">{state.result.translation}</div>
              <Button
                size="bare"
                onClick={handleCopy}
            ...
            {state.result.notes && (
              <div className="mt-1 text-[12px] text-t-3">{state.result.notes}</div>
            )}
          </div>
          <PhraseRefineBlock
