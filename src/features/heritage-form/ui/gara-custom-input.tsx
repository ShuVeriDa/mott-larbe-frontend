...
interface GaraCustomInputProps {
	value: string;
	onChange: (value: string) => void;
}

export const GaraCustomInput = ({ value, onChange }: GaraCustomInputProps) => {
	const { t } = useI18n();
	...
	return (
		<AnimatePresence>
			...
			>
				...
				<div>
					<InputLabel htmlFor="gara-custom-input">
						{t("heritage.gara_custom_label")}
					</InputLabel>
					<Input
						id="gara-custom-input"
						name="garaCustom"
						value={value}
						onChange={handleChange}
						placeholder={t("heritage.gara_custom_placeholder")}
						maxLength={100}
						className="text-[13px]"
					/>
