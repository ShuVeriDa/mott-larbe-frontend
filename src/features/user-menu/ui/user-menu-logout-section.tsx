...
export const UserMenuLogoutSection = ({ t, isPending, onLogout }: UserMenuLogoutSectionProps) => (
	<div className="border-t border-bd-1 py-1">
		<DropdownMenuPrimitive.Item asChild>
			<Button
				disabled={isPending}
				onClick={onLogout}
				className={cn(itemCls, "text-danger hover:bg-danger/8 focus-visible:bg-danger/8 disabled:opacity-50")}
			>
