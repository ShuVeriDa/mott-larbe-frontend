...
export const NoteCard = ({ note, onUpdate, onDelete, className }: NoteCardProps) => {
	...
	return (
		...
		>
			{note.selectedText && (
				<Typography className="mb-1.5 border-l-2 border-acc pl-2 text-[12px] text-t-3 italic line-clamp-2">
					{note.selectedText}
				</Typography>
			)}
			<Typography className="whitespace-pre-wrap text-t-1">{note.body}</Typography>
