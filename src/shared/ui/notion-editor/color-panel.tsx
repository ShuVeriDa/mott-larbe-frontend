...
export const BG_COLORS = [
	...
	{ label: "Brown bg",  value: "rgba(124,75,42,0.12)",     tw: "bg-[rgba(124,75,42,0.12)]" },
	{ label: "Orange bg", value: "rgba(217,119,6,0.12)",     tw: "bg-[rgba(217,119,6,0.12)]" },
	{ label: "Yellow bg", value: "rgba(202,138,4,0.12)",     tw: "bg-[rgba(202,138,4,0.12)]" },
	{ label: "Green bg",  value: "rgba(26,158,82,0.12)",     tw: "bg-[rgba(26,158,82,0.12)]" },
	{ label: "Blue bg",   value: "rgba(34,84,211,0.12)",     tw: "bg-[rgba(34,84,211,0.12)]" },
	{ label: "Purple bg", value: "rgba(109,78,212,0.12)",    tw: "bg-[rgba(109,78,212,0.12)]" },
	{ label: "Pink bg",   value: "rgba(219,39,119,0.12)",    tw: "bg-[rgba(219,39,119,0.12)]" },
	{ label: "Red bg",    value: "rgba(220,38,38,0.12)",     tw: "bg-[rgba(220,38,38,0.12)]" },
] as const;
...
export const ColorPanel = ({
	...
	const handlePanelMouseDown: NonNullable<ComponentProps<"div">["onMouseDown"]> = e => e.preventDefault();
		...
		>
			<div className="flex border-b border-bd-1">
				{(["text", "bg"] as const).map(t => {
					const handleTabMouseDown: NonNullable<ComponentProps<"button">["onMouseDown"]> = e => {
						e.preventDefault();
						setTab(t);
					};
					return (
					...
					<div className="grid grid-cols-5 gap-1.5">
						{TEXT_COLORS.map(c => {
							...
							return (
								...
								>
									<Typography tag="span" className="text-[13px] font-bold leading-none" style={{ color: c.value ?? "var(--t-1)" }}>
										A
									</Typography>
									<Typography tag="span" className="h-[3px] w-[14px] rounded-full" style={{ background: c.value ?? "var(--t-1)" }} />
									{isActive && (
