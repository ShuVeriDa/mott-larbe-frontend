...
import { StressMarkExtension } from "./stress-mark-extension";
...
import { PasteNormalizeExtension } from "./paste-normalize-extension";
...
export interface NotionEditorProps {
	...
	/** Text direction for the editable content — "rtl" for Arabic-language texts. Default: "ltr". */
	dir?: "ltr" | "rtl";
	/** Show the stress-mark toggle button in the bubble menu (Chechen texts only) */
	showStressMark?: boolean;
	/** Show "Add to spelling dictionary" button in the bubble menu (admin editors only) */
					...
					{(() => {
						...
						return (
							<BubbleMenuContent
								...
								showSpellingAdd={!isPhrase && !isAnnotation && showSpellingAdd}
