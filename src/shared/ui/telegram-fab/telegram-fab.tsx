	...
	return (
		...
		>
			...
			<div
				...
				className="relative flex items-center justify-between overflow-hidden rounded-full bg-[#229ED9] text-white transition-transform active:scale-95"
			>
				<div className="relative flex items-center">
					<button
						onClick={handleIconClick}
						aria-label={expanded ? t.close : t.open}
						className="flex size-9 shrink-0 items-center justify-center focus-visible:outline-none"
					>
					...
					<a
						...
						className="overflow-hidden whitespace-nowrap text-[12.5px] font-semibold leading-none text-white hover:underline focus-visible:outline-none"
					>
						{t.cta}
					</a>
				</div>
				...
				<button
					...
					className="flex shrink-0 items-center justify-center overflow-hidden text-white/70 hover:text-white focus-visible:outline-none"
				>
